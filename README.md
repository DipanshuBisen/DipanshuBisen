...
- Currently working in a development & integration environment
- Hands-on experience with containerization and orchestration
- Familiar with CI/CD pipelines and infrastructure automation
- Continuously learning and exploring cloud-native technologies
- Interested in building scalable and highly available systems
...
<p align="left">
  ...
  <img src="https://img.shields.io/badge/IBM-App%20Connect%20Enterprise-blue?style=for-the-badge" />
  <img src="https://img.shields.io/badge/IBM%20MQ-Messaging-blue?style=for-the-badge" />
  <img src="https://img.shields.io/badge/IBM-API%20Connect-black?style=for-the-badge" />
</p>
...
- Deployed applications on Kubernetes using Deployments and Services
- Worked with Docker for containerizing applications and managing images
- Built basic CI/CD pipelines using Jenkins
- Used Terraform for infrastructure provisioning (learning and implementing)
- Monitored applications using Prometheus and Grafana
- Worked on integration flows using IBM App Connect Enterprise (ACE)
...
I try to keep my repositories clean and focused on practical implementations. Most of my work is based on learning-by-doing and solving real use cases.
